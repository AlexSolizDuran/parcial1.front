...
export default function PersonaCreateView() {
    ...
    const url = process.env.NEXT_PUBLIC_API_URL + "/residencias/propietario/";
    ...
    const [propietarioData, setPropietarioData] = useState<Propietario>({
        usuario: usuarioData,
        fecha_compra: "",
        Qrpago: "",
    });
    ...
    const handleChange = (
        ...
        if (e.target instanceof HTMLInputElement && e.target.files) {
            ...
            setPropietarioData((prev) => ({ ...prev, [name]: value }));
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          ...
          const payload = {
            ...
            fecha_compra: propietarioData.fecha_compra,
          };
          ...
          router.push("/admin/usuarios/propietarios?created=true");
        ...
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <div className="border-b border-gray-200 pb-4 mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">
                    Complete los campos para añadir un nuevo propietario al sistema.
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <FormInput
                        ...
                        type="date"
                        name="fecha_compra"
                        value={propietarioData.fecha_compra}
                        onChange={handleChange}
                        required
                    />
