...
import { Seguridad } from "@/types/usuarios/seguridad";
...
export default function PersonaCreateView() {
    ...
    const [seguridadData, setSeguridadData] = useState<Seguridad>({
        usuario: usuarioData,
        turno: ""
    });
    ...
    const handleChange = (
        ...
        if (e.target instanceof HTMLInputElement && e.target.files) {
            ...
            setSeguridadData((prev) => ({ ...prev, [name]: value }));
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push("/admin/usuarios/seguridad?created=true");

        } catch (err: any) {
            console.error(err);
            setError(err.message || "Error al crear el Guardia");
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <div className="border-b border-gray-200 pb-4 mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">
                    Complete los campos para añadir un nuevo Guardia al sistema.
                </p>
            </div>
